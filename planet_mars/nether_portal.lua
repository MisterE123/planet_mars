...
nether.register_portal("martian_portal", {
		...
		frame_node_name     = "planet_mars:mars_portal",
		...
		book_of_portals_pagetext = [[Requiring 16 mars portal blocks, and constructed in the shape of a circle. A finished circle is 7 blocks high, and 7 blocks wide.
